...
export default function Footer() {
  return (
    <footer className="w-dvw flex h-74 justify-between bg-white px-16 py-7.5 text-black max-[1079px]:flex-wrap max-[1079px]:h-auto max-[1079px]:gap-y-8 max-[1079px]:px-8 max-[1079px]:py-12">
